...
<div class="col s12 m8 push-m2">
    ...
    <nav class="nav-extended orange darken-2">
        ...
        <a href="adicionar_vendedor.php" class="btn orange darken-1">Adicionar Vendedor</a>
    </nav>
        ...
        <table class="striped">
            ...
            <tbody>
                ...
                ?>
                        ...
                        <td><a href="editar_vendedor.php?id=<?php echo $dados['id']; ?>" class="btn-floating orange"><i class="material-icons">edit</i></a></td>
                        ...
                        <div id="modal<?php echo $dados['id']; ?>" class="modal">
                            ...
                            <h4>Ops!!</h4>
                            <p>Deseja realmente excluir esse vendedor?</p>
                            </div>
